...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`SupportGPT`}</title>

        <meta
          name="description"
          content="Experience seamless customer service with SupportGPT, your AI-powered solution for answering tickets and calls, perfectly integrated with your current WHMCS installation and ChatGPT."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless customer service with SupportGPT, your AI-powered solution for answering tickets and calls, perfectly integrated with your current WHMCS installation and ChatGPT.`}
            </Text>
            <Box
